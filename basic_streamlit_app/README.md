...
### Data: 
My app utilizes a Kaggle dataset titled "Spotify Tracks Dataset" which describes the musical characteristics of around 89,000 songs. It includes variables such as artists, album name, track name, popularity, danceability, energy, musical key, etc. 
